    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{route('admin.pharmacy')}}" class="nav-link">Pharmacy</a>
          </li>
          <li class="nav-item">
            <a href="{{route('admin.pathology')}}" class="nav-link">Pathology</a>
          </li>
          <li class="nav-item">
            <a href="#" class="nav-link">
              <i class=""></i>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('admin.visual_editor.home')}}" class="nav-link">
                  <i class=""></i>
                  <p>Home Page</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="{{route('admin.visual_editor.shop')}}" class="nav-link">
                  <i class=""></i>
                  <p>Shop Page</p>
                </a>
              
              <li class="nav-item">
                <a href="{{route('admin.visual_editor.contact')}}" class="nav-link">
                  <i class=""></i>
                  <p>Contact Page</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{route('admin.visual_editor.pharmacy')}}" class="nav-link">
                  <i class=""></i>
                  <p>Pharmacy Page</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{route('admin.visual_editor.eb_registration')}}" class="nav-link">
                  <i class=""></i>
