...
<style>
    ...
    <!-- ==========Page Header Section Start Here========== -->
            ...
            style="background-image: url({{asset('storage/public/visual_edits/' . $visualEditPharmacyContent['header_background_image'] ?? '')}})"
        >
            <div class="container">
                        ...
                        <div class="">
                            ...
                            <div class="form-group mb-3">
                                <input type="text" name="input_value" class="form-control"
                                    ...
                                    value="{{ $visualEditPharmacyContent['title'] ?? '' }}">
                            </div>
                                            ...
                                            <div class="">
                                                ...
                                                <div class="form-group mb-3">
                                                    <input type="text" name="input_value" class="form-control"
                                                        ...
                                                        value="{{ $visualEditPharmacyContent['breadcrumb_first_item_text'] ?? '' }}">
                                                </div>
                                            ...
                                            <div class="">
                                                ...
                                                <div class="form-group mb-3">
                                                    <input type="text" name="input_value" class="form-control"
                                                        ...
                                                        value="{{ $visualEditPharmacyContent['breadcrumb_first_item_link'] ?? '' }}">
                                                </div>
                                            ...
                                            <div class="">
                                                ...
                                                <div class="form-group mb-3">
                                                    <input type="text" name="input_value" class="form-control"
                                                        ...
                                                        value="{{ $visualEditPharmacyContent['breadcrumb_second_item_text'] ?? '' }}">
                                                </div>
                                            ...
                                            <div class="">
                                                ...
                                                <div class="form-group mb-3">
                                                    <input type="text" name="input_value" class="form-control"
                                                        ...
                                                        value="{{ $visualEditPharmacyContent['breadcrumb_second_item_link'] ?? '' }}">
                                                </div>
                    ...
                    <div class="service__maincontent">
                        ...
                        <form action="{{ route('admin.visual_edit.update') }}" method="POST">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea name="input_value" class="form-control wysiwyg-editor" id="pharmacy_description">{{ $visualEditPharmacyContent['pharmacy_description'] ?? 'Your online pharmacy' }}</textarea>
                            </div>
