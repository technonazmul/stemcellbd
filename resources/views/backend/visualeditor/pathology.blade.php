...
<style>
    ...
    .sidebar__appointment .head h6 {
     ...
     <!-- ==========Page Header Section Start Here========== -->
            ...
            style="background-image: url({{asset('storage/public/visual_edits/' . $visualEditPathologyContent['header_background_image'] ?? '')}})"
        >
            <div class="container">
                        ...
                        <div class="">
                            ...
                            <div class="form-group mb-3">
                                <input type="text" name="input_value" class="form-control"
                                    ...
                                    value="{{ $visualEditPathologyContent['title'] ?? '' }}">
                            </div>
                                            ...
                                            <div class="">
                                                ...
                                                <div class="form-group mb-3">
                                                    <input type="text" name="input_value" class="form-control"
                                                        ...
                                                        value="{{ $visualEditPathologyContent['breadcrumb_first_item_text'] ?? '' }}">
                                                </div>
                                            ...
                                            <div class="">
                                                ...
                                                <div class="form-group mb-3">
                                                    <input type="text" name="input_value" class="form-control"
                                                        ...
                                                        value="{{ $visualEditPathologyContent['breadcrumb_first_item_link'] ?? '' }}">
                                                </div>
                                            ...
                                            <div class="">
                                                ...
                                                <div class="form-group mb-3">
                                                    <input type="text" name="input_value" class="form-control"
                                                        ...
                                                        value="{{ $visualEditPathologyContent['breadcrumb_second_item_text'] ?? '' }}">
                                                </div>
                                            ...
                                            <div class="">
                                                ...
                                                <div class="form-group mb-3">
                                                    <input type="text" name="input_value" class="form-control"
                                                        ...
                                                        value="{{ $visualEditPathologyContent['breadcrumb_second_item_link'] ?? '' }}">
                                                </div>
                    ...
                    <div class="service__maincontent">
                        <form action="{{ route('admin.visual_edit.update') }}" method="POST">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea name="input_value" class="form-control wysiwyg-editor" id="pathology_description">{{ $visualEditPathologyContent['pathology_description'] ?? 'Your online pathology' }}</textarea>
                            </div>
