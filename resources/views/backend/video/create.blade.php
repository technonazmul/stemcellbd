    ...
    >
        ...
        <div class="mb-3">
            ...
            @if(isset($video) && $video->thumb_image)
                <img src="{{ asset('storage/' . $video->thumb_image) }}" width="150" alt="thumb" />
            @endif
        </div>
        ...
        <div class="mb-3">
            ...
            @if(isset($video) && $video->stat1_icon)
                <img src="{{ asset('storage/' . $video->stat1_icon) }}" width="50" alt="icon1" />
            @endif
        </div>
        ...
        <div class="mb-3">
            ...
            @if(isset($video) && $video->stat2_icon)
                <img src="{{ asset('storage/' . $video->stat2_icon) }}" width="50" alt="icon2" />
            @endif
        </div>
