        ...
        <div class="row">
            <div class="col-md-12 card card-body">
                ...
                <div class="mb-3">
                    ...
                    <input value="{{$general_info->meta_name}}" name="meta_name" type="text" class="form-control" id="exampleFormControlInput1" placeholder="Meta Name">
                </div>
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Meta Description</label>
                    <input value="{{$general_info->meta_description}}" name="meta_description" type="text" class="form-control" id="exampleFormControlInput1" placeholder="Meta Description">
                </div>
                <div class="mb-3">
