...
<style>
    ...
    <!-- ==========Page Header Section Start Here========== -->
            ...
            style="background-image: url(<?php echo e(asset('storage/public/visual_edits/' . $visualEditPharmacyContent['header_background_image'] ?? '')); ?>)"
        >
            <div class="container">
                ...
                <div class="pageheader__content">
                    ...
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="section" value="pharmacy_page">
                        ...
                        <div class="">
                            ...
                            <div class="form-group mb-3">
                                <input type="text" name="input_value" class="form-control"
                                    ...
                                    value="<?php echo e($visualEditPharmacyContent['title'] ?? ''); ?>">
                            </div>
                                            ...
                                            <div class="">
                                                ...
                                                <div class="form-group mb-3">
                                                    <input type="text" name="input_value" class="form-control"
                                                        ...
                                                        value="<?php echo e($visualEditPharmacyContent['breadcrumb_first_item_text'] ?? ''); ?>">
                                                </div>
                                            ...
                                            <div class="">
                                                ...
                                                <div class="form-group mb-3">
                                                    <input type="text" name="input_value" class="form-control"
                                                        ...
                                                        value="<?php echo e($visualEditPharmacyContent['breadcrumb_first_item_link'] ?? ''); ?>">
                                                </div>
                                            ...
                                            <div class="">
                                                ...
                                                <div class="form-group mb-3">
                                                    <input type="text" name="input_value" class="form-control"
                                                        ...
                                                        value="<?php echo e($visualEditPharmacyContent['breadcrumb_second_item_text'] ?? ''); ?>">
                                                </div>
                                            ...
                                            <div class="">
                                                ...
                                                <div class="form-group mb-3">
                                                    <input type="text" name="input_value" class="form-control"
                                                        ...
                                                        value="<?php echo e($visualEditPharmacyContent['breadcrumb_second_item_link'] ?? ''); ?>">
                                                </div>
                ...
                <div class="col-12">
                    <div class="service__maincontent">
                        ...
                        <form action="<?php echo e(route('admin.visual_edit.update')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <input type="hidden" name="section" value="pharmacy_page">
                            <input type="hidden" name="key" value="pharmacy_description">

                            <div class="form-group mb-3">
                                <label for="pharmacy_description" class="form-label fw-bold">Pharmacy Description</label>
                                <textarea name="input_value" class="form-control wysiwyg-editor" id="pharmacy_description"><?php echo e($visualEditPharmacyContent['pharmacy_description'] ?? 'Your online pharmacy'); ?></textarea>
                            </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.visualeditor.layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/Advancellhealth/resources/views/backend/visualeditor/pharmacy.blade.php ENDPATH**/ ?>