...
<style>
    ...
    <div class="pageheader bg-img" style="background-image: url(<?php echo e(asset('storage/public/visual_edits/' . $visualEditPathologyContent['header_background_image'] ?? '')); ?>);">
        <div class="container">
            <div class="pageheader__content">
                <h2><?php echo e($visualEditPathologyContent['title'] ?? 'Pathology'); ?></h2>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?php echo e($visualEditPathologyContent['breadcrumb_first_item_link'] ?? ''); ?>"><?php echo e($visualEditPathologyContent['breadcrumb_first_item_text'] ?? ''); ?></a></li>
                        <li class="breadcrumb-item active" aria-current="page"><?php echo e($visualEditPathologyContent['breadcrumb_second_item_text'] ?? 'Pathology'); ?></li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="row flex-row-reverse g-4">
                <div class="col-12">
                    <div class="service__maincontent">
                        <?php echo $visualEditPathologyContent['pathology_description'] ?? 'Your online pathology service'; ?>
...
<?php echo $__env->make('frontend.layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/Advancellhealth/resources/views/frontend/pages/pathology.blade.php ENDPATH**/ ?>