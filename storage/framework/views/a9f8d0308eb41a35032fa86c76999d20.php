    ...
    >
        ...
        <div class="mb-3">
            ...
            <?php if(isset($video) && $video->thumb_image): ?>
                <img src="<?php echo e(asset('storage/public/' . $video->thumb_image)); ?>" width="150" alt="thumb" />
            <?php endif; ?>
        </div>
        ...
        <div class="mb-3">
            ...
            <?php if(isset($video) && $video->stat1_icon): ?>
                <img src="<?php echo e(asset('storage/public/' . $video->stat1_icon)); ?>" width="50" alt="icon1" />
            <?php endif; ?>
        </div>
        ...
        <div class="mb-3">
            ...
            <?php if(isset($video) && $video->stat2_icon): ?>
                <img src="<?php echo e(asset('storage/public/' . $video->stat2_icon)); ?>" width="50" alt="icon2" />
            <?php endif; ?>
        </div>
...
<?php echo $__env->make('backend.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/Advancellhealth/resources/views/backend/video/edit.blade.php ENDPATH**/ ?>