...
<div class="container">
    <div class="row ">
        <div class="col-md-12 mx-auto">
            ...
            <form method="post" action="<?php echo e(route('admin.update_service',$edit_service->id)); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="card">
                    <div class="card-body">
                        <div class="mt-2">
                            <label for="exampleFormControlInput1" class="form-label">Title</label>
                            <input value="<?php echo e($edit_service->title); ?>" name="title" type="text" class="form-control" id="exampleFormControlInput1" placeholder="Title" required>
                        </div>
                        <img class="mt-1" src="<?php echo e(asset('storage/public/service/'.$edit_service->thumbnail)); ?>" style="max-width: 190px; height:190px;" alt="">
                        <div class="mt-2">
                        ...
                        <div class="mt-2">
                            ...
                            <textarea name="description" class="summernote"  >
                                <?php echo e($edit_service->description); ?>

                              </textarea>
                        </div>
                        <div class="mt-2">
                            <label for="exampleFormControlInput1" class="form-label">Tags</label>
                            <input name="tags" placeholder="" value="<?php echo e($edit_service->tags); ?>">
                        </div>
                        <div class="mt-2">
                            ...
                            <select name="service_category_id" class="form-control" id="exampleFormControlSelect1" required>
                                ...
                                <option value="<?php echo e($service_category->id); ?>"<?php if($service_category->id == $edit_service->service_category_id): ?> selected <?php endif; ?>><?php echo e($service_category->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                          <div class="mt-2">
                            <label for="exampleFormControlInput1" class="form-label">Meta Title</label>
                            <input value=" <?php echo e($edit_service->meta_title); ?>" name="meta_title" type="text" class="form-control" id="exampleFormControlInput1" placeholder="Meta Title">
                          </div>
                          <div class="mt-2">
                            <label for="exampleFormControlInput1" class="form-label">Meta Description</label>
                            <input value=" <?php echo e($edit_service->meta_description); ?>" name="meta_description" type="text" class="form-control" id="exampleFormControlInput1" placeholder="Meta Description">
                          </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/Advancellhealth/resources/views/backend/service/edit_service.blade.php ENDPATH**/ ?>