...
<!-- Page Header -->
<div class="pageheader bg-img" style="background-image: url(<?php echo e(asset('assets/images/bg/04.jpg')); ?>);">
    <div class="container">
...
<div class="checkout padding-tb section-bg">
    <div class="container">
        <form action="<?php echo e(route('order.place')); ?>" method="POST" id="checkout-form">
            <?php echo csrf_field(); ?>
            <div class="row g-5">
                <!-- Billing Details -->
                <div class="col-lg-8">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control" id="notes" name="notes" 
                                          rows="3" placeholder="Notes about your order, e.g. special notes for delivery."><?php echo e(old('notes')); ?></textarea>
                            </div>
                        </div>
                    ...
                    <div class="checkout__summary bg-light p-4 rounded">
                        ...
                        <div class="order-items">
                            <?php $__currentLoopData = $cart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="order-item d-flex justify-content-between align-items-center mb-3 pb-2 border-bottom">
                                    <div class="item-info">
                                        <h6 class="mb-1"><?php echo e($details['name']); ?></h6>
                                        <small class="text-muted">Qty: <?php echo e($details['quantity']); ?></small>
                                    </div>
                        ...
                        <div class="order-totals">
                            <div class="d-flex justify-content-between mb-3">
                                <span>Subtotal:</span>
                                <span id="subtotal-amount" class="fw-medium">৳<?php echo e(number_format($subtotal, 2)); ?></span>
                            </div>
                            ...
                            <div class="d-flex justify-content-between mb-4">
                                ...
                                <strong id="total-amount" class="fs-5 text-primary">৳<?php echo e(number_format($subtotal + 70, 2)); ?></strong>
                            </div>
...
<?php echo $__env->make('frontend.layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/Advancellhealth/resources/views/frontend/pages/checkout.blade.php ENDPATH**/ ?>