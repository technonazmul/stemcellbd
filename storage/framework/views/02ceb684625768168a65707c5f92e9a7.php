    ...
    <form action="<?php echo e(route('admin.update_banner', $banner->id)); ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <?php if(!empty($banner->background_image)): ?>
                <div class="mt-2">
                    <img src="<?php echo e(asset('storage/' . $banner->background_image)); ?>" alt="Banner Background"
        ...
        <div class="mb-3">
            ...
            <?php if(!empty($banner->video)): ?>
                <div class="mt-2">
                    <video src="<?php echo e(asset('storage/' . $banner->video)); ?>" controls style="max-width: 300px;"></video>
                </div>
            <?php endif; ?>
        </div>
...
<?php echo $__env->make('backend.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbookair/Desktop/Laravel/stemcellbd/resources/views/backend/generalinfo/banner.blade.php ENDPATH**/ ?>