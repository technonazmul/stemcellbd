                    ...
                    <div class="col-xl-7 col-lg-6 col-12">
                        <div class="info">
                            <ul>
                                ...
                                <li>
                                    <a href="<?php echo e(route('admin.general_info')); ?>" style="color: white;"><i class="icofont-edit"></i></a>
                                </li>
                                            ...
                                            <div class="">
                                                ...
                                                <div class="form-group mb-3">
                                                    <input type="text" name="input_value" class="form-control"
                                                        ...
                                                        value="<?php echo e($headerVisuals['login_button_text'] ?? ''); ?>">
                                                </div>
        ...
        <div class="header__bottom">
            <div class="container">
                <div class="header__bottom--area">
                    <div class="logo">
                        <a href="<?php echo e(route('index')); ?>"><img src="<?php echo e(asset('storage/public/logos/'.$general_info->logo)); ?>" alt="logo"></a>
                         <a href="<?php echo e(route('admin.general_info')); ?>" style="color: black;"><i class="icofont-edit"></i></a>
                    </div>
                    ...
                    <div class="menupart">
                        <div class="menu">
                            ...
                            <ul>
                                ...
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <li><a href="<?php echo e(route('admin.menus.index')); ?>" style="color: black;"><i class="icofont-edit"></i></a></li>
                            </ul>
                        </div>
                        <div class="cartbtn">
                            <div class="cart">
                            ...
                            <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#headerEditModal">
                                Edit <?php echo e($headerVisuals['appointment_button_text'] ?? ''); ?> Button
                            </button>
                            ...
                            <div class="modal-dialog">
                                ...
                                <div class="modal-header">
                                    <h5 class="modal-title" id="headerEditModalLabel">Edit <?php echo e($headerVisuals['appointment_button_text'] ?? ''); ?> Button</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                
                                <div class="modal-body">
                                    <!-- Form: Button Text -->
                                    <form action="<?php echo e(route('admin.visual_edit.update')); ?>" method="POST" class="mb-3">
                                    <?php echo csrf_field(); ?>
                                    <input type="hidden" name="section" value="header">
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="text" name="input_value" class="form-control"
                                            value="<?php echo e($headerVisuals['appointment_button_text'] ?? ''); ?>">
                                    </div>
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="text" name="input_value" class="form-control"
                                            value="<?php echo e($headerVisuals['appointment_button_link'] ?? ''); ?>">
                                    </div>
                                ...
                                <div class="">
                                    ...
                                    <div class="form-group mb-3">
                                        <input type="text" name="input_value" class="form-control border-1 display-5 fw-bold"
                                            ...
                                            value="<?php echo e($footerVisuals['newsletter_title'] ?? ''); ?>">
                                    </div>
                            ...
                            <div class="footer__title">
                                ...
                                <div class="">
                                    ...
                                    <div class="form-group mb-3">
                                        <input type="text" name="input_value" class="form-control border-1 display-5 fw-bold"
                                            style="font-size: 2rem;"
                                            value="<?php echo e($footerVisuals['about_us_title'] ?? ''); ?>">
                                    </div>
                            ...
                            <form action="<?php echo e(route('admin.visual_edit.update')); ?>" method="POST">
                                ...
                                <div class="">
                                    ...
                                    <div class="form-group mb-3">
                                        <input type="text" name="input_value" class="form-control border-1 display-5 fw-bold"
                                            style="font-size: 2rem;"
                                            value="<?php echo e($footerVisuals['follow_us_title'] ?? ''); ?>">
                                    </div>
                            ...
                            <div class="footer__title">
                                ...
                                <div class="">
                                    ...
                                    <div class="form-group mb-3">
                                        <input type="text" name="input_value" class="form-control border-1 display-5 fw-bold"
                                            style="font-size: 2rem;"
                                            value="<?php echo e($footerVisuals['products_title'] ?? ''); ?>">
                                    </div>
                            ...
                            <form action="<?php echo e(route('admin.visual_edit.update')); ?>" method="POST">
                                ...
                                <div class="">
                                    ...
                                    <div class="form-group mb-3">
                                        <input type="text" name="input_value" class="form-control border-1 display-5 fw-bold"
                                            style="font-size: 2rem;"
                                            value="<?php echo e($footerVisuals['blogs_title'] ?? ''); ?>">
                                    </div>
                            ...
                            <div class="footer__title">
                                ...
                                <div class="">
                                    ...
                                    <div class="form-group mb-3">
                                        <input type="text" name="input_value" class="form-control border-1 display-5 fw-bold"
                                            style="font-size: 2rem;"
                                            value="<?php echo e($footerVisuals['photo_gallery_title'] ?? ''); ?>">
                                    </div>
...
</html><?php /**PATH /Applications/MAMP/htdocs/Advancellhealth/resources/views/backend/visualeditor/layouts/template.blade.php ENDPATH**/ ?>