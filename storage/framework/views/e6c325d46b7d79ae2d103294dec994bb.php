...
<style>
    ...
    <!-- ==========Page Header Section Start Here========== -->
            ...
            style="background-image: url(<?php echo e(asset('storage/public/visual_edits/' . $visualEditAmbulanceContent['header_background_image'] ?? '')); ?>)"
        >
            <div class="container">
                        ...
                        <div class="">
                            ...
                            <div class="form-group mb-3">
                                <input type="text" name="input_value" class="form-control"
                                    ...
                                    value="<?php echo e($visualEditAmbulanceContent['title'] ?? ''); ?>">
                            </div>
                                            ...
                                            <div class="">
                                                ...
                                                <div class="form-group mb-3">
                                                    <input type="text" name="input_value" class="form-control"
                                                        ...
                                                        value="<?php echo e($visualEditAmbulanceContent['breadcrumb_first_item_text'] ?? ''); ?>">
                                                </div>
                                            ...
                                            <div class="">
                                                ...
                                                <div class="form-group mb-3">
                                                    <input type="text" name="input_value" class="form-control"
                                                        ...
                                                        value="<?php echo e($visualEditAmbulanceContent['breadcrumb_first_item_link'] ?? ''); ?>">
                                                </div>
                                            ...
                                            <div class="">
                                                ...
                                                <div class="form-group mb-3">
                                                    <input type="text" name="input_value" class="form-control"
                                                        ...
                                                        value="<?php echo e($visualEditAmbulanceContent['breadcrumb_second_item_text'] ?? ''); ?>">
                                                </div>
                                            ...
                                            <div class="">
                                                ...
                                                <div class="form-group mb-3">
                                                    <input type="text" name="input_value" class="form-control"
                                                        ...
                                                        value="<?php echo e($visualEditAmbulanceContent['breadcrumb_second_item_link'] ?? ''); ?>">
                                                </div>
                    ...
                    <div class="service__maincontent">
                        ...
                        <form action="<?php echo e(route('admin.visual_edit.update')); ?>" method="POST">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea name="input_value" class="form-control wysiwyg-editor" id="ambulance_description"><?php echo e($visualEditAmbulanceContent['ambulance_description'] ?? 'Your online pharmacy'); ?></textarea>
                            </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.visualeditor.layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/Advancellhealth/resources/views/backend/visualeditor/ambulance.blade.php ENDPATH**/ ?>