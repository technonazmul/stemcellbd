...
<?php $__env->startSection("content"); ?>
    ...
    <div class="pageheader bg-img" style="background-image: url(<?php echo e(asset('storage/public/visual_edits/' . $visualEditEbRegistrationContent['header_background_image'] ?? '')); ?>);">
        <div class="container">
            <div class="pageheader__content">
                <h2><?php echo e($visualEditEbRegistrationContent['header_title'] ?? 'Early Bird Registration'); ?></h2>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?php echo e($visualEditEbRegistrationContent['breadcrumb_first_item_link'] ?? ''); ?>"><?php echo e($visualEditEbRegistrationContent['breadcrumb_first_item_text'] ?? ''); ?></a></li>
                        <li class="breadcrumb-item active" aria-current="page"><?php echo e($visualEditEbRegistrationContent['breadcrumb_second_item_text'] ?? 'Early Bird Registration'); ?></li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <form action="<?php echo e(route('eb_form_submit')); ?>" method="Post">
            <?php echo csrf_field(); ?>
          <div class="row ">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/Advancellhealth/resources/views/frontend/pages/eb_registration.blade.php ENDPATH**/ ?>