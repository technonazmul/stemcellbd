...
<?php $__env->startSection("content"); ?>
    <!-- ==========Page Header Section Start Here========== -->
            ...
            style="background-image: url(<?php echo e(asset('storage/public/visual_edits/' . $visualEditEbRegistrationContent['header_background_image'] ?? '')); ?>)"
        >
            <div class="container">
                        ...
                        <div class="">
                            ...
                            <div class="form-group mb-3">
                                <input type="text" name="input_value" class="form-control"
                                    ...
                                    value="<?php echo e($visualEditEbRegistrationContent['title'] ?? ''); ?>">
                            </div>
                                            ...
                                            <div class="">
                                                ...
                                                <div class="form-group mb-3">
                                                    <input type="text" name="input_value" class="form-control"
                                                        ...
                                                        value="<?php echo e($visualEditEbRegistrationContent['breadcrumb_first_item_text'] ?? ''); ?>">
                                                </div>
                                            ...
                                            <div class="">
                                                ...
                                                <div class="form-group mb-3">
                                                    <input type="text" name="input_value" class="form-control"
                                                        ...
                                                        value="<?php echo e($visualEditEbRegistrationContent['breadcrumb_first_item_link'] ?? ''); ?>">
                                                </div>
                                            ...
                                            <div class="">
                                                ...
                                                <div class="form-group mb-3">
                                                    <input type="text" name="input_value" class="form-control"
                                                        ...
                                                        value="<?php echo e($visualEditEbRegistrationContent['breadcrumb_second_item_text'] ?? ''); ?>">
                                                </div>
                                            ...
                                            <div class="">
                                                ...
                                                <div class="form-group mb-3">
                                                    <input type="text" name="input_value" class="form-control"
                                                        ...
                                                        value="<?php echo e($visualEditEbRegistrationContent['breadcrumb_second_item_link'] ?? ''); ?>">
                                                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.visualeditor.layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/Advancellhealth/resources/views/backend/visualeditor/eb_registration.blade.php ENDPATH**/ ?>