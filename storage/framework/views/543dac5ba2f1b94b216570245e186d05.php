...
<style>
    ...
    .sidebar__appointment .head h6 {
     ...
     <!-- ==========Page Header Section Start Here========== -->
            ...
            style="background-image: url(<?php echo e(asset('storage/public/visual_edits/' . $visualEditPathologyContent['header_background_image'] ?? '')); ?>)"
        >
            <div class="container">
                ...
                <div class="pageheader__content">
                    ...
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="section" value="pathology_page">
                        ...
                        <div class="">
                            ...
                            <div class="form-group mb-3">
                                <input type="text" name="input_value" class="form-control"
                                    ...
                                    value="<?php echo e($visualEditPathologyContent['title'] ?? ''); ?>">
                            </div>
                                            ...
                                            <div class="">
                                                ...
                                                <div class="form-group mb-3">
                                                    <input type="text" name="input_value" class="form-control"
                                                        ...
                                                        value="<?php echo e($visualEditPathologyContent['breadcrumb_first_item_text'] ?? ''); ?>">
                                                </div>
                                            ...
                                            <div class="">
                                                ...
                                                <div class="form-group mb-3">
                                                    <input type="text" name="input_value" class="form-control"
                                                        ...
                                                        value="<?php echo e($visualEditPathologyContent['breadcrumb_first_item_link'] ?? ''); ?>">
                                                </div>
                                            ...
                                            <div class="">
                                                ...
                                                <div class="form-group mb-3">
                                                    <input type="text" name="input_value" class="form-control"
                                                        ...
                                                        value="<?php echo e($visualEditPathologyContent['breadcrumb_second_item_text'] ?? ''); ?>">
                                                </div>
                                            ...
                                            <div class="">
                                                ...
                                                <div class="form-group mb-3">
                                                    <input type="text" name="input_value" class="form-control"
                                                        ...
                                                        value="<?php echo e($visualEditPathologyContent['breadcrumb_second_item_link'] ?? ''); ?>">
                                                </div>
                ...
                <div class="col-12">
                    <div class="service__maincontent">
                        <form action="<?php echo e(route('admin.visual_edit.update')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <input type="hidden" name="section" value="pathology_page">
                            <input type="hidden" name="key" value="pathology_description">

                            <div class="form-group mb-3">
                                <label for="pathology_description" class="form-label fw-bold"> Description</label>
                                <textarea name="input_value" class="form-control wysiwyg-editor" id="pathology_description"><?php echo e($visualEditPathologyContent['pathology_description'] ?? 'Your online pathology'); ?></textarea>
                            </div>
                        ...
                        <form action="<?php echo e(route('pathologySubmit')); ?>" id="contact-form" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="row g-3">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.visualeditor.layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/Advancellhealth/resources/views/backend/visualeditor/pathology.blade.php ENDPATH**/ ?>