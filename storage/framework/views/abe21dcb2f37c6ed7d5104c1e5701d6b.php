...
<div class="container">
    ...
    <form action="<?php echo e(route('admin.update_general_info',$general_info)); ?>" method="post" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div class="row">
            <div class="col-md-12 card card-body">
                ...
                <div class="mb-3">
                    ...
                    <img src="<?php echo e(asset('storage/public/logos/'.$general_info->logo)); ?>" alt="Logo" class="img-fluid mb-2" style="max-width: 500px;">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                 ...
                 <div class="mb-3">
                    ...
                    <input value="<?php echo e($general_info->map); ?>" name="map" type="text" class="form-control" id="official_hour" placeholder="Google Map Url" >
                </div>

                <div class="mb-3">
                    <label for="office_day" class="form-label">Official Day</label>
                    <input value="<?php echo e($general_info->office_day); ?>" name="office_day" type="text" class="form-control" id="office_day" placeholder="Sat - Thu" >
                </div>

                <div class="mb-3">
                    <label for="official_hour" class="form-label">Office Hour</label>
                    <input value="<?php echo e($general_info->official_hour); ?>" name="official_hour" type="text" class="form-control" id="official_hour" placeholder="8:00 AM - 6: 00 PM" >
                </div>
...
<?php echo $__env->make('backend.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/Advancellhealth/resources/views/backend/generalinfo/general_info.blade.php ENDPATH**/ ?>